...
public class CRRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput output) {
        ...
        withConditions(output, new TagsPopulatedResourceCondition(cTag("common/grass")))
            .accept(CompostableRecipes.id("common/grass"), new CompostableRecipe(cTag("grass"), 0.3f), null);
        withConditions(output, new TagsPopulatedResourceCondition(cTag("common/grass_like")))
            .accept(CompostableRecipes.id("common/grass_like"), new CompostableRecipe(cTag("grass_like"), 0.3f), null);
        withConditions(output, new TagsPopulatedResourceCondition(cTag("common/grass_variants")))
            .accept(CompostableRecipes.id("common/grass_variants"), new CompostableRecipe(cTag("grass_variants"), 0.3f), null);
        withConditions(output, new TagsPopulatedResourceCondition(cTag("storage_blocks/rice")))
            .accept(CompostableRecipes.id("storage_blocks/rice"), new CompostableRecipe(cTag("storage_blocks/rice"), 1.0f), null);
        withConditions(output, new TagsPopulatedResourceCondition(cTag("storage_blocks/sugar_cane")))
            .accept(CompostableRecipes.id("storage_blocks/sugar_cane"), new CompostableRecipe(cTag("storage_blocks/sugar_cane"), 1.0f), null);
    }
